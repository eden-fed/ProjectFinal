...
MStatus reconstructRBFCmd::doIt(const MArgList & argList)
{
	...
	MatlabInterface::GetEngine().LoadAndRunScriptToString("C:/Users/eden/Documents/MySWProjects/ProjectFinal/DGP-HW1/DGP_CODE_DIR/matlab scripts/reconstructRBF.m");
